...
from bitcoin_parser.blockHeader import BlockHeader
from bitcoin_parser.transaction import Transaction
from utils.classHelper import format_hash, double_sha256
from utils.streamer import decode_varint
...
def get_block_transactions(raw_hex):
    ...
    # Decoding the number of transactions, offset is the size of the varint (1 to 9 bytes)
