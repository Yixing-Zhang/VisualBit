...
def is_public_key(hex_data):
    """
    Given a bytes string, returns whether it is probably a bitcoin
    public key or not. It doesn't actually ensures that the data is a valid
    public key, just that it looks like one
    """
...
class Script(object):
    """
    This class models the bitcoin script contained in an input or output
    """
