...
from bitcoin_parser.input import Input
from bitcoin_parser.output import Output
from utils.classHelper import double_sha256, format_hash, bip69_sort
from utils.streamer import decode_varint, decode_uint32


class Transaction(object):
    """
    This class models the bitcoin transaction.
    """
